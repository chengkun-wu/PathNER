...
public class Tag
{
    ...
    {
        String propertiesFilename = "banner.properties"; // banner.properties
        String modelFilename = "gene.bin"; // model.bin
        String inputFilename = "test.txt";
        String outputFilename = "banner.out";
        ...
        for (int end = breaker.next(); end != BreakIterator.DONE; start = end, end = breaker.next())
        {
            ...
            {try{
                ...
                for (Mention m : sentence.getMentions()){
                	System.out.println(m.getSentence().getText());
                }
                
                outputWriter.println(sentence.getSGML());
            }catch(Exception e){
            	System.out.println("Exception found for text");
            	continue;
            }
        ...
        System.out.println("Gene Mentions All Found!");
    }
}
